...
class DepositControllerTest {
    ...
    void getAllDeposits_returns200WithList() throws Exception {
        when(depositService.findAll()).thenReturn(List.of(buildResponse()));
    ...
    void getDepositById_returns200_whenFound() throws Exception {
        when(depositService.findById(100L)).thenReturn(buildResponse());
    ...
    void getDepositById_returns404_whenNotFound() throws Exception {
        when(depositService.findById(99L)).thenThrow(new DepositNotFoundException(99L));
    ...
    void createDeposit_returns201WithBody_whenValid() throws Exception {
        ...
        when(depositService.create(any(CreateDepositRequest.class))).thenReturn(buildResponse());
